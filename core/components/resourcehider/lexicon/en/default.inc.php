<?php
/**
 * Default English Lexicon Entries for ResourceHider
 *
...
$_lang['resourcehider.error_msg_noaction'] = 'No or unknown action provided';
$_lang['resourcehider.error_msg_save'] = 'Error while saving the resource data';
$_lang['resourcehider.hidden_children'] = 'Has hidden children';
$_lang['resourcehider.hidden_type_all'] = 'All kind';
$_lang['resourcehider.hidden_type_children'] = 'With hidden children';
$_lang['resourcehider.hidden_type_hidden'] = 'Hidden from the tree';
$_lang['resourcehider.hide_children_in_tree'] = 'Hide children';
...
$_lang['setting_resourcehider.allowed_classes_desc'] = 'A comma separated list of resource classes which you will be able to toggle the visibility. Defaults to modResource, modDocument, modSymLink, modWebLink & modStaticResource.';
$_lang['setting_resourcehider.allowed_contexts'] = 'Allowed contexts';
